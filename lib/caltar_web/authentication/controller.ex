defmodule CaltarWeb.Authentication.Controller do
  use CaltarWeb, :controller

  alias Caltar.Accounts
  alias Caltar.Schema.User
  alias CaltarWeb.Authentication

  plug(:put_view, html: CaltarWeb.Authentication.View)

  action_fallback(CaltarWeb.Error.Controller)
